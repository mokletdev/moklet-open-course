...
const TestimonialSection = () => {
    const settings = {
        ...
        appendDots: (dots: React.ReactNode) => (
            <div>
                <ul className="absolute -top-[380px] md:-top-[330px] lg:top-0 lg:-left-[105%] lg:-translate-y-[54px] space-x-2">{dots}</ul>
            </div>
        ),
        customPaging: () => (
...
//         appendDots: (dots: React.ReactNode) => (
//             <div>
//                 <ul className="flex justify-start space-x-2">{dots}</ul>
//             </div>
//         ),
//         customPaging: () => (
